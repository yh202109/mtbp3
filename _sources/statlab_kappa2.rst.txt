...
.. math::
  ...
  =&  R + R(R-1)\left(7\sum_j p_j^2 + 6(R-2)\sum_j\p_j^3 + (R-2)(R-3\sum_j p_j^4)\right) \\
   & + R(R-1) + R(R-1)\left((2R-5)\sum_jp_j^2+(R-2)(R-3)(\sum_j p_j^2)^2 -2(R-1)\sum_jp_j^2 - (R-2)(R-3)\sum_jp_j^4\right) \\
   & + R^2 + R(R-1)\left(2R\sum_j p_j^2 + R(R-1)(\sum_jp_j^2)^2\right)
